...
func _build() -> void:
	...
	var panel := Panel.new()
	panel.size = Vector2(420.0, 148.0)
	panel.add_theme_stylebox_override("panel", UITheme.box_style(UITheme.PANEL_FILL, UITheme.GOLD, 2))
