...
const HEROES := {
	...
	"zhang_fei": {
		...
		"skills": [
			{"name": "普攻·丈八掷阵", "type": "普攻", "description": "前两式扫阵挑飞；第三式向摇杆方向跃起并猛砸地面，造成范围伤害与击退。"},
			{"name": "被动·燕人怒势", "type": "被动", "description": "连续击杀会进入怒势，强化飞兵冲量、碰撞伤害和贯穿次数。"},
			{"name": "主动·据水断桥", "type": "主动", "description": "向摇杆方向跃起并猛砸地面，造成更大范围、更高伤害与强力击退。"},
			{"name": "无双·万夫莫开", "type": "无双", "description": "消耗 40 能量，怒喝震阵后进入 10 秒万夫状态；自身减伤，飞兵撞击与连锁强化，第三式跃砸范围与冲量提升。"},
		],
		"talent_tree": [
			{"title": "掷阵", "core_title": "基础掷阵", "core_summary": "扫阵、挑飞与掷阵默认开放。", "nodes": [{"id": "zhang_heavy_roar", "summary": "飞兵冲量", "is_core": true}, {"id": "zhang_rage", "summary": "怒势强化", "is_core": true}]},
			{"title": "断桥", "core_title": "基础断桥", "core_summary": "跃砸与范围震退默认开放。", "nodes": [{"id": "zhang_iron_hide", "summary": "铁躯震地", "is_core": true}]},
			{"title": "无双", "core_title": "基础万夫莫开", "core_summary": "万夫莫开默认开放。", "nodes": [{"id": "zhang_earthshaker", "summary": "飞兵贯阵", "is_core": true}]},
		],
	},
	"zhao_yun": {
		"id": "zhao_yun",
