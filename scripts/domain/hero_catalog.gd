...
const HEROES := {
	"guan_yu": {
		...
		"skills": [
			...
			{"name": "无双·武圣", "type": "无双", "description": "消耗70能量，持续15秒强化攻击与移速；青龙断浪冷却减半（最低3.5秒），期间支持格挡。"},
		],
		"talent_tree": [
	...
	"zhang_fei": {
		...
		"skills": [
			...
			{"name": "无双·万夫莫开", "type": "无双", "description": "消耗 60 能量，怒喝震阵后进入 10 秒万夫状态；自身减伤，飞兵撞击与连锁强化，第三式跃砸范围与冲量提升，期间支持格挡。"},
		],
		"talent_tree": [
	...
	"zhao_yun": {
		...
		"skills": [
			...
			{"name": "被动·龙胆", "type": "被动", "description": "击杀基础敌军积累进度；命中精英 +3、领主 +5，达到 15 点后获得护体与疾行。"},
			{"name": "主动·破军", "type": "主动", "description": "沿当前面朝高速穿阵，击退路径敌军，落点追加横扫。"},
			{"name": "无双·七进七出", "type": "无双", "description": "消耗 60 能量，七段可转向龙影穿阵，终段造成高额伤害；期间不支持格挡。"},
		],
		"talent_tree": [
			{
				"title": "枪法",
