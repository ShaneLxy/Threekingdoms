...
const DEFINITIONS := {
	...
	"zhang_heavy_roar": {"title": "蛇矛裂阵", "category": "蛇矛", "description": "普攻范围扩大，击退距离提高。", "max_stacks": 3},
	"zhang_iron_hide": {"title": "燕人铁壁", "category": "断桥", "description": "防御提高，据水断桥的格挡持续时间延长。", "max_stacks": 3},
	"zhang_rage": {"title": "怒势迸发", "category": "怒势", "description": "立刻获得短暂怒势，并提高招式伤害。", "max_stacks": 3},
	"zhang_earthshaker": {"title": "喝断长坂", "category": "无双", "description": "当阳怒吼伤害与架势伤害提高。", "max_stacks": 3},
